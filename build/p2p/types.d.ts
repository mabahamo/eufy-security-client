...
export declare const RequestMessageType: {
    STUN: Buffer<ArrayBuffer>;
    LOOKUP: Buffer<ArrayBuffer>;
    LOOKUP_WITH_KEY: Buffer<ArrayBuffer>;
    LOOKUP_WITH_KEY2: Buffer<ArrayBuffer>;
    TURN_LOOKUP_WITH_KEY: Buffer<ArrayBuffer>;
    TURN_SERVER_INIT: Buffer<ArrayBuffer>;
    TURN_CLIENT_OK: Buffer<ArrayBuffer>;
    CHECK_CAM2: Buffer<ArrayBuffer>;
    LOCAL_LOOKUP: Buffer<ArrayBuffer>;
    PING: Buffer<ArrayBuffer>;
    PONG: Buffer<ArrayBuffer>;
    CHECK_CAM: Buffer<ArrayBuffer>;
    DATA: Buffer<ArrayBuffer>;
    ACK: Buffer<ArrayBuffer>;
    END: Buffer<ArrayBuffer>;
};
export declare const ResponseMessageType: {
    STUN: Buffer<ArrayBuffer>;
    LOOKUP_RESP: Buffer<ArrayBuffer>;
    LOOKUP_ADDR: Buffer<ArrayBuffer>;
    LOCAL_LOOKUP_RESP: Buffer<ArrayBuffer>;
    TURN_SERVER_LIST: Buffer<ArrayBuffer>;
    TURN_SERVER_OK: Buffer<ArrayBuffer>;
    TURN_SERVER_TOKEN: Buffer<ArrayBuffer>;
    TURN_SERVER_LOOKUP_OK: Buffer<ArrayBuffer>;
    LOOKUP_ADDR2: Buffer<ArrayBuffer>;
    UNKNOWN_83: Buffer<ArrayBuffer>;
    TURN_SERVER_CAM_ID: Buffer<ArrayBuffer>;
    END: Buffer<ArrayBuffer>;
    PONG: Buffer<ArrayBuffer>;
    PING: Buffer<ArrayBuffer>;
    CAM_ID: Buffer<ArrayBuffer>;
    ACK: Buffer<ArrayBuffer>;
    DATA: Buffer<ArrayBuffer>;
};
