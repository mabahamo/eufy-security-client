...
class Station extends tiny_typed_emitter_1.TypedEmitter {
    ...
    update(station) {
        ...
        logging_1.rootHTTPLogger.debug("Update station cloud properties", {
        ...
        if ((this.properties[name] !== undefined && this.properties[name] !== value) ||
            ...
            try {
                ...
                if (error instanceof error_2.InvalidPropertyError) {
                    logging_1.rootHTTPLogger.error(`Station update property - Invalid Property error`, {
                    ...
                    logging_1.rootHTTPLogger.error(`Station update property - Property error`, {
                        error: (0, utils_3.getError)(error),
                        stationSN: this.getSerial(),
                        propertyName: name,
                        propertyValue: value,
        ...
        if (parsedValue !== undefined &&
            ...
            if (this.ready) {
                ...
                try {
                    ...
                    const error = (0, error_1.ensureError)(err);
                    logging_1.rootHTTPLogger.error("Station update raw property - Number conversion error", {
                        error: (0, utils_3.getError)(error),
                        stationSN: this.getSerial(),
                        type: type,
                        value: value,
                ...
                if (property.key === type) {
                    try {
                        ...
                        if (error instanceof error_2.PropertyNotSupportedError) {
                            logging_1.rootHTTPLogger.debug("Station update raw property - Property not supported error", {
                                error: (0, utils_3.getError)(error),
                                stationSN: this.getSerial(),
                                type: type,
                                value: value,
                            ...
                            logging_1.rootHTTPLogger.error("Station update raw property - Property error", {
                                error: (0, utils_3.getError)(error),
                                stationSN: this.getSerial(),
                                type: type,
                                value: value,
        ...
        try {
            switch (property.key) {
                ...
                case types_2.CommandType.CMD_GET_ALARM_MODE: {
                    ...
                    return Number.parseInt(value !== undefined
                        ? value
                        : guard_mode !== undefined && guard_mode !== types_1.GuardMode.SCHEDULE && guard_mode !== types_1.GuardMode.GEO
                            ? guard_mode
                            : types_1.GuardMode.UNKNOWN.toString());
                }
                case types_2.CommandType.CMD_HUB_NOTIFY_MODE: {
                    switch (property.name) {
                        case types_1.PropertyName.StationNotificationSwitchModeSchedule:
                            if (this.isStationHomeBase2OrOlder() && !(0, utils_1.isGreaterEqualMinVersion)("2.1.1.6", this.getSoftwareVersion())) {
                                return value !== undefined ? (value === "1" ? true : false) : false;
                            }
                            return value !== undefined
                                ? (0, utils_1.isNotificationSwitchMode)(Number.parseInt(value), types_1.NotificationSwitchMode.SCHEDULE)
                                : false;
                        case types_1.PropertyName.StationNotificationSwitchModeGeofence:
                            if (this.isStationHomeBase2OrOlder() && !(0, utils_1.isGreaterEqualMinVersion)("2.1.1.6", this.getSoftwareVersion())) {
                                throw new error_2.PropertyNotSupportedError("Property not supported for station with this software version", {
                                    context: {
                            ...
                            return value !== undefined
                                ? (0, utils_1.isNotificationSwitchMode)(Number.parseInt(value), types_1.NotificationSwitchMode.GEOFENCE)
                                : false;
                        case types_1.PropertyName.StationNotificationSwitchModeApp:
                            ...
                            return value !== undefined
                                ? (0, utils_1.isNotificationSwitchMode)(Number.parseInt(value), types_1.NotificationSwitchMode.APP)
                                : false;
                        case types_1.PropertyName.StationNotificationSwitchModeKeypad:
                            ...
                            return value !== undefined
                                ? (0, utils_1.isNotificationSwitchMode)(Number.parseInt(value), types_1.NotificationSwitchMode.KEYPAD)
                                : false;
                    }
                }
                ...
                case types_2.CommandType.CMD_HUB_ALARM_TONE:
                    try {
                        ...
                        const error = (0, error_1.ensureError)(err);
                        logging_1.rootHTTPLogger.error("Station convert raw property - CMD_HUB_ALARM_TONE Error", {
                            error: (0, utils_3.getError)(error),
                            stationSN: this.getSerial(),
                            property: property,
                            value: value,
                ...
                case types_2.CommandType.CMD_SET_HUB_SPK_VOLUME:
                    try {
                        ...
                        const error = (0, error_1.ensureError)(err);
                        logging_1.rootHTTPLogger.error("Station convert raw property - CMD_SET_HUB_SPK_VOLUME Error", {
                            error: (0, utils_3.getError)(error),
                            stationSN: this.getSerial(),
                            property: property,
                            value: value,
                ...
                case types_2.CommandType.CMD_SET_PROMPT_VOLUME:
                    try {
                        ...
                        const error = (0, error_1.ensureError)(err);
                        logging_1.rootHTTPLogger.error("Station convert raw property - CMD_SET_PROMPT_VOLUME Error", {
                            error: (0, utils_3.getError)(error),
                            stationSN: this.getSerial(),
                            property: property,
                            value: value,
                ...
                case types_2.CommandType.CMD_SET_HUB_OSD:
                    try {
                        ...
                        const error = (0, error_1.ensureError)(err);
                        logging_1.rootHTTPLogger.error("Station convert raw property - CMD_SET_HUB_OSD Error", {
                            error: (0, utils_3.getError)(error),
                            stationSN: this.getSerial(),
                            property: property,
                            value: value,
            ...
            if (property.name === types_1.PropertyName.Model && device_1.Device.isLockWifiT8510P(this.getDeviceType(), this.getSerial())) {
                ...
                try {
                    ...
                    const error = (0, error_1.ensureError)(err);
                    logging_1.rootHTTPLogger.warn("Station convert raw property - PropertyMetadataNumeric Convert Error", {
                        error: (0, utils_3.getError)(error),
                        stationSN: this.getSerial(),
                        property: property,
                        value: value,
                ...
                try {
                    ...
                    const error = (0, error_1.ensureError)(err);
                    logging_1.rootHTTPLogger.warn("Station convert raw property - PropertyMetadataBoolean Convert Error", {
                        error: (0, utils_3.getError)(error),
                        stationSN: this.getSerial(),
                        property: property,
                        value: value,
            ...
            const error = (0, error_1.ensureError)(err);
            logging_1.rootHTTPLogger.error("Station convert raw property - Error", {
                error: (0, utils_3.getError)(error),
                stationSN: this.getSerial(),
                property: property,
                value: value,
    ...
    getPropertyValue(name) {
        if (name === types_1.PropertyName.StationCurrentMode) {
            ...
            return this.properties[types_1.PropertyName.StationCurrentMode] !== undefined
                ? this.properties[types_1.PropertyName.StationCurrentMode]
                : guard_mode !== undefined && guard_mode !== types_1.GuardMode.SCHEDULE && guard_mode !== types_1.GuardMode.GEO
                    ? guard_mode
                    : types_1.GuardMode.UNKNOWN;
        }
    ...
    static getChannel(type) {
        return Station.isStation(type) === true
            ? device_1.Device.isIndoorCamera(type)
    ...
    static isStationHomeBase2OrOlder(type) {
        return type === types_1.DeviceType.STATION;
    }
     ...
     * @returns Returns true, if this is a HomeBase 3 or a HomeBase mini, otherwise false.
     */
    static isDeviceControlledByHomeBaseBySn(sn) {
    ...
    isIntegratedDevice() {
        ...
        if (device_1.Device.isLock(this.getDeviceType()) ||
            device_1.Device.isSmartDrop(this.getDeviceType()) ||
            device_1.Device.isSmartSafe(this.getDeviceType())) {
            if (this.rawStation.devices?.length === 1)
                return this.rawStation.devices[0]?.device_sn === this.rawStation.station_sn;
            else
                return true;
        }
        return (device_1.Device.isWiredDoorbellDual(this.getDeviceType()) ||
            device_1.Device.isFloodLight(this.getDeviceType()) ||
            device_1.Device.isWiredDoorbell(this.getDeviceType()) ||
            device_1.Device.isIndoorCamera(this.getDeviceType()) ||
            device_1.Device.isSoloCameras(this.getDeviceType()) ||
            device_1.Device.isWallLightCam(this.getDeviceType()) ||
            device_1.Device.isStarlight4GLTE(this.getDeviceType()) ||
            device_1.Device.isSoloCameraPro(this.getDeviceType()));
    }
    isP2PConnectableDevice() {
        if (device_1.Device.isSmartTrack(this.getDeviceType()) || (!device_1.Device.isSupported(this.getDeviceType()) && !this.isStation())) {
            if (!device_1.Device.isSupported(this.getDeviceType()) && !this.isStation()) {
                logging_1.rootHTTPLogger.debug("Station not supported, no connection over p2p will be initiated", {
                    stationSN: this.getSerial(),
    ...
    getCurrentMode() {
        const guard_mode = this.getGuardMode();
        return this.getPropertyValue(types_1.PropertyName.StationCurrentMode) !== undefined
            ? this.getPropertyValue(types_1.PropertyName.StationCurrentMode)
            : guard_mode !== undefined && guard_mode !== types_1.GuardMode.SCHEDULE && guard_mode !== types_1.GuardMode.GEO
                ? guard_mode
                : types_1.GuardMode.UNKNOWN;
    }
    processPushNotification(message) {
        if (message.type !== undefined && message.event_type !== undefined) {
            if (message.event_type === types_3.CusPushEvent.MODE_SWITCH && message.station_sn === this.getSerial()) {
                logging_1.rootHTTPLogger.info("Received push notification for changing guard mode", {
                ...
                try {
                    ...
                    const error = (0, error_1.ensureError)(err);
                    logging_1.rootHTTPLogger.debug(`Station process push notification - MODE_SWITCH event error`, {
                        error: (0, utils_3.getError)(error),
                        stationSN: this.getSerial(),
            ...
            else if (message.event_type === types_3.CusPushEvent.ALARM &&
                message.station_sn === this.getSerial() &&
                !this.isStation()) {
                logging_1.rootHTTPLogger.info("Received push notification for alarm event", {
                    stationSN: message.station_sn,
        ...
        else if (message.msg_type === types_3.CusPushEvent.TFCARD &&
            message.station_sn === this.getSerial() &&
    ...
    async connect() {
        if (!this.p2pSession.isConnected() && !this.p2pSession.isConnecting()) {
            logging_1.rootHTTPLogger.debug(`Connecting to station ${this.getSerial()}...`, {
                stationSN: this.getSerial(),
                p2pConnectionType: types_2.P2PConnectionType[this.p2pConnectionType],
            });
    ...
    setGuardMode(mode) {
        ...
        if (((0, utils_1.isGreaterEqualMinVersion)("2.0.7.9", this.getSoftwareVersion()) &&
            !device_1.Device.isIntegratedDeviceBySn(this.getSerial())) ||
            device_1.Device.isSoloCameraBySn(this.getSerial()) ||
            this.rawStation.device_type === types_1.DeviceType.HB3) {
            logging_1.rootHTTPLogger.debug(`Station set guard mode - Using CMD_SET_PAYLOAD`, {
                stationSN: this.getSerial(),
                mode: mode,
            ...
            logging_1.rootHTTPLogger.debug(`Station set guard mode - Using CMD_SET_ARMING`, {
                stationSN: this.getSerial(),
                mode: mode,
            });
    ...
    getStorageInfoEx() {
        ...
        if (this.isStation() &&
            this.rawStation.device_type !== types_1.DeviceType.HB3 &&
            this.rawStation.device_type !== types_1.DeviceType.HOMEBASE_MINI &&
            (0, utils_1.isGreaterEqualMinVersion)("3.2.7.6", this.getSoftwareVersion())) {
    ...
    getArmDelay(mode) {
        ...
        if (propertyName !== undefined &&
            ...
            try {
                ...
                const error = (0, error_1.ensureError)(err);
                logging_1.rootHTTPLogger.debug(`Station get arm delay - Error`, {
                    error: (0, utils_3.getError)(error),
                    stationSN: this.getSerial(),
                    mode: mode,
    ...
    _getDeviceSerial(channel) {
        if (this.rawStation.devices) {
            ...
            if (devices) {
                ...
                logging_1.rootHTTPLogger.error(`Station get device serial - No devices found`, {
                    station: this.getSerial(),
                    channel: channel,
                });
            }
    ...
    _handleCameraInfoParameters(devices, channel, type, value) {
        if (channel === Station.CHANNEL ||
            channel === Station.CHANNEL_INDOOR ||
            (this.isIntegratedDevice() && this.getDeviceType() !== types_1.DeviceType.HB3)) {
    ...
    onCommandResponse(result) {
        logging_1.rootHTTPLogger.debug("Station got p2p command response", {
            station: this.getSerial(),
            commandType: result.command_type,
            channel: result.channel,
            returnCodeName: types_2.ErrorCode[result.return_code],
    ...
    onSecondaryCommandResponse(result) {
        logging_1.rootHTTPLogger.debug("Station got p2p secondary command response", {
            station: this.getSerial(),
            commandType: result.command_type,
            channel: result.channel,
            returnCode: result.return_code,
    ...
    setStatusLed(device, value) {
        ...
        if (device.getStationSerial() !== this.getSerial()) {
            throw new error_1.WrongStationError("Device is not managed by this station", {
                context: {
        ...
        logging_1.rootHTTPLogger.debug(`Station set status led - sending command`, {
            stationSN: this.getSerial(),
        ...
        if (device.isCamera2Product() ||
            ...
            device.getDeviceType() === types_1.DeviceType.CAMERA ||
            device.getDeviceType() === types_1.DeviceType.CAMERA_E ||
            ...
            (device.getDeviceType() === types_1.DeviceType.FLOODLIGHT && !device.isFloodLightT8420X()) ||
    ...
    setAutoNightVision(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set auto night vision - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setNightVision(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set night vision - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setMotionDetection(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set motion detection - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
        ...
        else if ((device.isIndoorCamera() && !device.isIndoorPanAndTiltCameraS350()) ||
            (device.isFloodLight() && device.getDeviceType() !== types_1.DeviceType.FLOODLIGHT) ||
    ...
    setSoundDetection(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set sound detection - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setSoundDetectionType(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set sound detection type - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setSoundDetectionSensitivity(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set sound detection sensitivity - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setPetDetection(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set pet detection - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    panAndTilt(device, direction, command = 1) {
        ...
        if (!(direction in types_2.PanTiltDirection)) {
            throw new error_1.InvalidCommandValueError("Invalid value for this command", {
                context: {
                    device: device.getSerial(),
                    station: this.getSerial(),
                    commandName: commandData.name,
        ...
        logging_1.rootHTTPLogger.debug(`Station pan and tilt - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            direction: types_2.PanTiltDirection[direction],
            command,
        });
    ...
    switchLight(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station switch light - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
        if ((device.isFloodLight() && !device.isFloodLightT8425()) ||
    ...
    setMotionDetectionSensitivity(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set motion detection sensitivity - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
        if ((device.isFloodLight() && device.getDeviceType() !== types_1.DeviceType.FLOODLIGHT && !device.isFloodLightT8425()) ||
        ...
        else if ((device.isBatteryDoorbell() && !device.isBatteryDoorbellDual()) ||
    ...
    setMotionDetectionType(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set motion detection type - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setMotionDetectionTypeHB3(device, type, value) {
        const propertyData = {
            name: type === types_1.HB3DetectionTypes.HUMAN_RECOGNITION
                ? types_1.PropertyName.DeviceMotionDetectionTypeHumanRecognition
                : type === types_1.HB3DetectionTypes.HUMAN_DETECTION || type === types_1.T8170DetectionTypes.HUMAN_DETECTION
                    ? types_1.PropertyName.DeviceMotionDetectionTypeHuman
                    : type === types_1.HB3DetectionTypes.PET_DETECTION
                        ? types_1.PropertyName.DeviceMotionDetectionTypePet
                        : type === types_1.HB3DetectionTypes.VEHICLE_DETECTION
                            ? types_1.PropertyName.DeviceMotionDetectionTypeVehicle
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set motion detection type HB3 - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            type: type,
            value: value,
        ...
        if (this.getDeviceType() === types_1.DeviceType.HB3) {
            try {
                ...
                const aiDetectionType = device.getRawProperty(device.getPropertyMetadata(propertyData.name).key) !== undefined
                    ? device.getRawProperty(device.getPropertyMetadata(propertyData.name).key)
                    : "0";
                ...
                const error = (0, error_1.ensureError)(err);
                logging_1.rootHTTPLogger.error(`setMotionDetectionTypeHB3 Error`, {
                    error: (0, utils_3.getError)(error),
                    stationSN: this.getSerial(),
                    deviceSN: device.getSerial(),
                });
            ...
            try {
                ...
                const error = (0, error_1.ensureError)(err);
                logging_1.rootHTTPLogger.error(`setMotionDetectionTypeHB3 T8170DetectionTypes Error`, {
                    error: (0, utils_3.getError)(error),
                    stationSN: this.getSerial(),
                    deviceSN: device.getSerial(),
                });
            ...
            try {
                if (!Object.values(types_1.EufyCamC35DetectionTypes).includes(type)) {
                    logging_1.rootHTTPLogger.error(`The device ${device.getSerial()} accepts only this type of values:`, Object.values(types_1.EufyCamC35DetectionTypes).filter((value) => typeof value === "number"));
                    return;
                }
                const aiDetectionType = device.getRawProperty(device.getPropertyMetadata(propertyData.name).key) !== undefined
                    ? device.getRawProperty(device.getPropertyMetadata(propertyData.name).key)
                    : "0";
                const newAiDetectionType = (0, utils_1.getT8110DetectionMode)(Number.parseInt(aiDetectionType), type, value);
                this.p2pSession.sendCommandWithStringPayload({
                    commandType: types_2.CommandType.CMD_SET_PAYLOAD,
                    value: JSON.stringify({
                        account_id: this.rawStation.member.admin_user_id,
                ...
                const error = (0, error_1.ensureError)(err);
                logging_1.rootHTTPLogger.error(`setMotionDetectionTypeHB3 EufyCamC35DetectionTypes Error`, {
                    error: (0, utils_3.getError)(error),
                    stationSN: this.getSerial(),
                    deviceSN: device.getSerial(),
                });
            ...
            try {
                ...
                if (!value) {
                    newAiDetectionType =
                        type === types_1.SoloCameraDetectionTypes.ALL_OTHER_MOTION
                            ? types_1.SoloCameraDetectionTypes.HUMAN_DETECTION
                            : types_1.SoloCameraDetectionTypes.ALL_OTHER_MOTION;
                }
                this.p2pSession.sendCommandWithStringPayload({
                    commandType: types_2.CommandType.CMD_SET_PAYLOAD,
                    value: JSON.stringify({
                ...
                const error = (0, error_1.ensureError)(err);
                logging_1.rootHTTPLogger.error(`setMotionDetectionTypeHB3 SoloCameraDetectionTypes Error`, {
                    error: (0, utils_3.getError)(error),
                    stationSN: this.getSerial(),
                    deviceSN: device.getSerial(),
                });
            ...
            try {
                ...
                const error = (0, error_1.ensureError)(err);
                logging_1.rootHTTPLogger.error(`setMotionDetectionTypeHB3 IndoorS350DetectionTypes Error`, {
                    error: (0, utils_3.getError)(error),
                    stationSN: this.getSerial(),
                    deviceSN: device.getSerial(),
                });
    ...
    setMotionZone(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set motion zone - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setMotionTracking(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set motion tracking - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setPanAndTiltRotationSpeed(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set pan and tilt rotation speed - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setMicMute(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set mic mute - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setAudioRecording(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set audio recording - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
        ...
        else if ((device.isFloodLight() && !device.isFloodLightT8425()) ||
            (device.isIndoorCamera() && !device.isIndoorPanAndTiltCameraS350()) ||
            (device.isSoloCameras() && !this.isDeviceControlledByHomeBase()) ||
            device.isStarlight4GLTE()) {
            this.p2pSession.sendCommandWithStringPayload({
    ...
    enableSpeaker(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station enable speaker - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setSpeakerVolume(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set speaker volume - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setRingtoneVolume(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set ringtone volume - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    enableIndoorChime(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station enable indoor chime - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    enableHomebaseChime(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station enable homebase chime - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setHomebaseChimeRingtoneVolume(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set homebase chime ringtone volume - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setHomebaseChimeRingtoneType(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set homebase chime ringtone type - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setNotificationType(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set notification type - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setNotificationPerson(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set notification person - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setNotificationPet(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set notification pet - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setNotificationAllOtherMotion(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set notification all other motion - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setNotificationAllSound(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set notification all sound - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setNotificationCrying(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set notification crying - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setNotificationRing(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set notification ring - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
        if (device.isBatteryDoorbell() || device.isWiredDoorbellDual()) {
            ...
            this.p2pSession.sendCommandWithStringPayload({
                ...
                value: JSON.stringify({
                    ...
                    data: {
                        type: value === true
                            ? device.getPropertyValue(types_1.PropertyName.DeviceNotificationMotion) === true
                                ? 3
                                : 1
                            : device.getPropertyValue(types_1.PropertyName.DeviceNotificationMotion) === true
                                ? 2
    ...
    setNotificationMotion(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set notification motion - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
        if (device.isBatteryDoorbell() || device.isWiredDoorbellDual()) {
            ...
            this.p2pSession.sendCommandWithStringPayload({
                ...
                value: JSON.stringify({
                    ...
                    data: {
                        type: value === true
                            ? device.getPropertyValue(types_1.PropertyName.DeviceNotificationRing) === true
                                ? 3
                                : 2
                            : device.getPropertyValue(types_1.PropertyName.DeviceNotificationRing) === true
                                ? 1
    ...
    setPowerSource(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set power source - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setPowerWorkingMode(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set power working mode - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setRecordingClipLength(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set recording clip length - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setRecordingRetriggerInterval(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set recording retrigger interval - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setRecordingEndClipMotionStops(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set recording end clip motion stops - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setVideoStreamingQuality(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set video streaming quality - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setVideoRecordingQuality(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set video recording quality - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setWDR(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set wdr - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setFloodlightLightSettingsEnable(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings enable - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setFloodlightLightSettingsBrightnessManual(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings brightness manual - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setFloodlightLightSettingsBrightnessMotion(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings brightness motion - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setFloodlightLightSettingsBrightnessSchedule(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings brightness schedule - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setFloodlightLightSettingsMotionTriggered(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings motion triggered - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setFloodlightLightSettingsMotionTriggeredDistance(device, value) {
        ...
        switch (value) {
            ...
            case 5:
                ...
                break;
            default:
                throw new error_1.InvalidPropertyValueError("Invalid value for this property", {
                    context: {
                        device: device.getSerial(),
                        station: this.getSerial(),
                        propertyName: propertyData.name,
        ...
        logging_1.rootHTTPLogger.debug(`Station set light settings motion triggered distance - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: newValue,
        });
    ...
    setFloodlightLightSettingsMotionTriggeredTimer(device, seconds) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set light settings motion triggered timer - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: seconds,
        });
    ...
    triggerStationAlarmSound(seconds) {
        ...
        logging_1.rootHTTPLogger.debug(`Station trigger station alarm sound - sending command`, {
            stationSN: this.getSerial(),
            value: seconds,
        });
        if (!(0, utils_1.isGreaterEqualMinVersion)("2.0.7.9", this.getSoftwareVersion()) ||
    ...
    triggerDeviceAlarmSound(device, seconds) {
        ...
        logging_1.rootHTTPLogger.debug(`Station trigger device alarm sound - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: seconds,
        });
    ...
    setStationAlarmRingtoneVolume(value) {
        ...
        const property = this.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set station alarm ringtone volume - sending command`, {
            stationSN: this.getSerial(),
            value: value,
        });
    ...
    setStationAlarmTone(value) {
        ...
        const property = this.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set station alarm tone - sending command`, {
            stationSN: this.getSerial(),
            value: value,
        });
        this.p2pSession.sendCommandWithStringPayload({
    ...
    setStationPromptVolume(value) {
        ...
        const property = this.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set station prompt volume - sending command`, {
            stationSN: this.getSerial(),
            value: value,
        });
        this.p2pSession.sendCommandWithStringPayload({
    ...
    setStationNotificationSwitchMode(mode, value) {
        const propertyData = {
            name: mode === types_1.NotificationSwitchMode.APP
                ? types_1.PropertyName.StationNotificationSwitchModeApp
                : mode === types_1.NotificationSwitchMode.GEOFENCE
                    ? types_1.PropertyName.StationNotificationSwitchModeGeofence
                    : mode === types_1.NotificationSwitchMode.KEYPAD
                        ? types_1.PropertyName.StationNotificationSwitchModeKeypad
                        : mode === types_1.NotificationSwitchMode.SCHEDULE
        ...
        if ((!this.hasProperty(types_1.PropertyName.StationNotificationSwitchModeApp) && mode === types_1.NotificationSwitchMode.APP) ||
            (!this.hasProperty(types_1.PropertyName.StationNotificationSwitchModeGeofence) &&
                mode === types_1.NotificationSwitchMode.GEOFENCE) ||
            (!this.hasProperty(types_1.PropertyName.StationNotificationSwitchModeKeypad) && mode === types_1.NotificationSwitchMode.KEYPAD) ||
            (!this.hasProperty(types_1.PropertyName.StationNotificationSwitchModeSchedule) &&
                mode === types_1.NotificationSwitchMode.SCHEDULE)) {
            throw new error_1.NotSupportedError("This functionality is not implemented or supported", {
                context: { propertyName: propertyData.name, propertyValue: propertyData.value, station: this.getSerial() },
            });
        ...
        const property = this.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set station notification switch mode - sending command`, {
            stationSN: this.getSerial(),
            mode: mode,
            value: value,
        });
            ...
            this.p2pSession.sendCommandWithStringPayload({
                ...
                value: JSON.stringify({
                    ...
                    payload: {
                        ...
                        notify_alarm_delay: this.getPropertyValue(types_1.PropertyName.StationNotificationStartAlarmDelay) !== undefined
                            ? this.getPropertyValue(types_1.PropertyName.StationNotificationStartAlarmDelay) === true
                                ? 1
                                : 0
                            : 0,
                        notify_mode: 0,
        ...
        else if (this.getDeviceType() === types_1.DeviceType.OUTDOOR_PT_CAMERA ||
            device_1.Device.isSoloCameraC210(this.getDeviceType()) ||
            (device_1.Device.isCameraC35(this.getDeviceType()) && !this.isDeviceControlledByHomeBase())) {
            let oldvalue = 0;
            const rawproperty = this.getRawProperty(types_2.CommandType.CMD_HUB_NOTIFY_MODE);
            if (rawproperty !== undefined) {
                try {
    ...
    setStationNotificationStartAlarmDelay(value) {
        ...
        const property = this.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set station notification start alarm delay - sending command`, {
            stationSN: this.getSerial(),
            value: value,
        });
    ...
    setStationTimeFormat(value) {
        ...
        const property = this.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set station time format - sending command`, {
            stationSN: this.getSerial(),
            value: value,
        });
        if (device_1.Device.isWallLightCam(this.getDeviceType())) {
    ...
    setRTSPStream(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set rtsp stream - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setAntiTheftDetection(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set anti theft detection - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setWatermark(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set watermark - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    enableDevice(device, value) {
        ...
        if ((device.isIndoorCamera() && !device.isIndoorCamMini() && !device.isIndoorPanAndTiltCameraS350()) ||
            (device.isWiredDoorbell() && !device.isWiredDoorbellT8200X()) ||
            device.getDeviceType() === types_1.DeviceType.FLOODLIGHT_CAMERA_8422 ||
            device.getDeviceType() === types_1.DeviceType.FLOODLIGHT_CAMERA_8424 ||
            device.isFloodLightT8420X())
            param_value = value === true ? 1 : 0;
        logging_1.rootHTTPLogger.debug(`Station enable device - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
        if (device.isIndoorCamMini()) {
            ...
            (0, utils_1.isGreaterEqualMinVersion)("2.3.1.0", device.getSoftwareVersion()) &&
    ...
    async startDownload(device, path, cipher_id) {
        ...
        logging_1.rootHTTPLogger.debug(`Station start download - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            path: path,
            cipherID: cipher_id,
        ...
        if (this.getDeviceType() === types_1.DeviceType.HB3) {
            ...
            /*this.rawStation.station_sn, */ cipher_id, this.rawStation.member.admin_user_id);
    ...
    cancelDownload(device) {
        ...
        logging_1.rootHTTPLogger.debug(`Station cancel download - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
        });
        this.p2pSession.sendCommandWithInt({
    ...
    startLivestream(device, videoCodec = types_2.VideoCodec.H264) {
        ...
        if (this.isLiveStreaming(device)) {
            throw new error_2.LivestreamAlreadyRunningError("Livestream for device is already running", {
                context: {
                    device: device.getSerial(),
                    station: this.getSerial(),
                    commandName: commandData.name,
        ...
        logging_1.rootHTTPLogger.debug(`Station start livestream - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
        ...
        if (device.isSmartDrop()) {
            logging_1.rootHTTPLogger.debug(`Station start livestream - sending command (smart drop)`, {
                stationSN: this.getSerial(),
                deviceSN: device.getSerial(),
                videoCodec: videoCodec,
                main_sw_version: this.getSoftwareVersion(),
            ...
            device.isGarageCamera()) {
            logging_1.rootHTTPLogger.debug(`Station start livestream - sending command using CMD_DOORBELL_SET_PAYLOAD (2)`, {
                stationSN: this.getSerial(),
                deviceSN: device.getSerial(),
                videoCodec: videoCodec,
                main_sw_version: this.getSoftwareVersion(),
            ...
            (device.getSerial().startsWith("T8420") && (0, utils_1.isGreaterEqualMinVersion)("2.0.4.8", this.getSoftwareVersion()))) {
            logging_1.rootHTTPLogger.debug(`Station start livestream - sending command using CMD_DOORBELL_SET_PAYLOAD (3)`, {
                stationSN: this.getSerial(),
                deviceSN: device.getSerial(),
                videoCodec: videoCodec,
                main_sw_version: this.getSoftwareVersion(),
            ...
            if (((device_1.Device.isIntegratedDeviceBySn(this.getSerial()) ||
                !(0, utils_1.isGreaterEqualMinVersion)("2.0.9.7", this.getSoftwareVersion())) &&
                (!this.getSerial().startsWith("T8420") ||
                    !(0, utils_1.isGreaterEqualMinVersion)("1.0.0.25", this.getSoftwareVersion()))) ||
                device.isLockWifiVideo()) {
    ...
    stopLivestream(device) {
        ...
        if (!this.isLiveStreaming(device)) {
            throw new error_2.LivestreamNotRunningError("Livestream for device is not running", {
                context: {
                    device: device.getSerial(),
                    station: this.getSerial(),
                    commandName: commandData.name,
        ...
        logging_1.rootHTTPLogger.debug(`Station stop livestream - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
        });
        this.p2pSession.sendCommandWithInt({
    ...
    quickResponse(device, voice_id) {
        ...
        logging_1.rootHTTPLogger.debug(`Station quick response - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            voiceID: voice_id,
        });
        if (device.isBatteryDoorbell() || device.isLockWifiVideo()) {
            ...
            logging_1.rootHTTPLogger.debug(`Station quick response - sending command using CMD_DOORBELL_SET_PAYLOAD`, {
                stationSN: this.getSerial(),
                deviceSN: device.getSerial(),
                voiceID: voice_id,
            });
    ...
    setChirpVolume(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set chirp volume - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setChirpTone(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set chirp tone - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setHDR(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set hdr - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setDistortionCorrection(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set distortion correction - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setRingRecord(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set ring record - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    lockDevice(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station lock device - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setStationSwitchModeWithAccessCode(value) {
        ...
        const property = this.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set station switch mode with access code - sending command`, {
            stationSN: this.getSerial(),
            value: value,
        });
        if (this.isStation()) {
    ...
    setStationAutoEndAlarm(value) {
        ...
        const property = this.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station station auto end alarm - sending command`, {
            stationSN: this.getSerial(),
            value: value,
        });
        if (this.isStation()) {
    ...
    setStationTurnOffAlarmWithButton(value) {
        ...
        const property = this.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set station turn off alarm with button - sending command`, {
            stationSN: this.getSerial(),
            value: value,
        });
        if (this.isStation()) {
    ...
    startRTSPStream(device) {
        ...
        if (rtspStreamProperty !== undefined && rtspStreamProperty !== true) {
            throw new error_1.RTSPPropertyNotEnabledError("RTSP setting for this device must be enabled first, to enable this functionality!", {
                context: {
                    device: device.getSerial(),
                    station: this.getSerial(),
                    propertyName: types_1.PropertyName.DeviceRTSPStream,
        ...
        logging_1.rootHTTPLogger.debug(`Station start rtsp stream - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
        });
        this.p2pSession.sendCommandWithIntString({
    ...
    stopRTSPStream(device) {
        ...
        logging_1.rootHTTPLogger.debug(`Station stop rtsp stream - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
        });
        this.p2pSession.sendCommandWithIntString({
    ...
    setMotionDetectionRange(device, type) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set motion detection range - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: type,
        });
    ...
    setMotionDetectionRangeStandardSensitivity(device, sensitivity) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set motion detection range standard sensitivity - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: sensitivity,
        });
    ...
    setMotionDetectionRangeAdvancedLeftSensitivity(device, sensitivity) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, sensitivity);
        logging_1.rootHTTPLogger.debug(`Station motion detection range advanced left sensitivity - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: sensitivity,
        });
    ...
    setMotionDetectionRangeAdvancedMiddleSensitivity(device, sensitivity) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, sensitivity);
        logging_1.rootHTTPLogger.debug(`Station set motion detection range advanced middle sensitivity - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: sensitivity,
        });
    ...
    setMotionDetectionRangeAdvancedRightSensitivity(device, sensitivity) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, sensitivity);
        logging_1.rootHTTPLogger.debug(`Station set motion detection range advanced right sensitivity - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: sensitivity,
        });
    ...
    setMotionDetectionTestMode(device, enabled) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set motion detection test mode - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: enabled,
        });
        if (device.getDeviceType() === types_1.DeviceType.FLOODLIGHT_CAMERA_8423 ||
            device.getDeviceType() === types_1.DeviceType.FLOODLIGHT) {
            this.p2pSession.sendCommandWithIntString({
            ...
            if (rawProperty !== undefined && rawProperty.cur_mode !== undefined) {
                ...
                const currentMode = payload.cur_mode === 0
                    ? payload.mode0
                    : payload.cur_mode === 1
                        ? payload.mode1
                        : payload.cur_mode === 2
    ...
    setMotionTrackingSensitivity(device, sensitivity) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, sensitivity);
        logging_1.rootHTTPLogger.debug(`Station set motion tracking sensitivity - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: sensitivity,
        });
    ...
    setMotionAutoCruise(device, enabled) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, enabled);
        logging_1.rootHTTPLogger.debug(`Station set motion auto cruise - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: enabled,
        });
    ...
    setMotionOutOfViewDetection(device, enabled) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, enabled);
        logging_1.rootHTTPLogger.debug(`Station set motion out of view detection - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: enabled,
        });
    ...
    setLightSettingsColorTemperatureManual(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings color temperature manual - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setLightSettingsColorTemperatureMotion(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings color temperature motion - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setLightSettingsColorTemperatureSchedule(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings color temperature schedule - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setLightSettingsMotionActivationMode(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings motion activation mode - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setVideoNightvisionImageAdjustment(device, enabled) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, enabled);
        logging_1.rootHTTPLogger.debug(`Station set video night vision image adjustment - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: enabled,
        });
    ...
    setVideoColorNightvision(device, enabled) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, enabled);
        logging_1.rootHTTPLogger.debug(`Station set video color night vision - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: enabled,
        });
    ...
    setAutoCalibration(device, enabled) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, enabled);
        logging_1.rootHTTPLogger.debug(`Station set auto calibration - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: enabled,
        });
    ...
    calibrateLock(device) {
        ...
        logging_1.rootHTTPLogger.debug(`Station calibrate lock - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
        });
    ...
    setAdvancedLockParams(device, property, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set advanced lock params - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            property: property,
            value: value,
        ...
        if (device.isLockWifi() || device.isLockWifiNoFinger()) {
            ...
            if (p2pParamName !== "") {
                ...
                logging_1.rootHTTPLogger.debug("Station set advanced lock params - Set lock param...", {
                    station: this.getSerial(),
                    device: device.getSerial(),
                    admin_user_id: this.rawStation.member.admin_user_id,
                    property: property,
                ...
                throw new error_2.InvalidPropertyError("Internal lock property for property not identified for this device", {
                    context: {
                        device: device.getSerial(),
                        station: this.getSerial(),
                        propertyName: propertyData.name,
    ...
    setLoiteringDetection(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set loitering detection - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setLoiteringDetectionRange(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set loitering detection range - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setLoiteringDetectionLength(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set loitering detection length - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    _setMotionDetectionSensitivity(device, propertyData, mode, blocklist) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set motion detection sensitivty - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
    ...
    _setLoiteringCustomResponse(device, propertyData, voiceID, autoVoiceResponse, homebaseAlert, pushNotification, startTime, endTime) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, propertyData.value);
        logging_1.rootHTTPLogger.debug(`Station set loitering custom response - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            propertyData: propertyData,
            voiceID: voiceID,
    ...
    setDeliveryGuard(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set delivery guard - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setDeliveryGuardPackageGuarding(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set delivery guard package guarding - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setDeliveryGuardPackageGuardingVoiceResponseVoice(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, propertyData.value);
        logging_1.rootHTTPLogger.debug(`Station set delivery guard package guarding voice response voice - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setDeliveryGuardPackageGuardingActivatedTime(device, propertyData, startTime, endTime) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, propertyData.value);
        logging_1.rootHTTPLogger.debug(`Station set delivery guard guarding activated time - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            propertyData: propertyData,
            startTime: repl_1.start,
            endTime: endTime,
        });
        if (device.isBatteryDoorbellDual() || device.isWiredDoorbellDual() || device.isBatteryDoorbellDualE340()) {
            this.p2pSession.sendCommandWithStringPayload({
    ...
    setDeliveryGuardUncollectedPackageAlert(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set delivery guard uncollected package alert - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setDeliveryGuardUncollectedPackageAlertTimeToCheck(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, propertyData.value);
        logging_1.rootHTTPLogger.debug(`Station set delivery guard uncollected package alert time to check - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setDeliveryGuardPackageLiveCheckAssistance(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set delivery guard package live check assistance - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setDualCamWatchViewMode(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, propertyData.value);
        logging_1.rootHTTPLogger.debug(`Station set dual cam watch view mode - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    _setRingAutoResponse(device, propertyData, enabled, voiceID, autoVoiceResponse, startTime, endTime) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, propertyData.value);
        logging_1.rootHTTPLogger.debug(`Station set ring auto response - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            propertyData: propertyData,
            enabled: enabled,
    ...
    setNotificationRadarDetector(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set notification radar detector - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    calibrate(device) {
        ...
        logging_1.rootHTTPLogger.debug(`Station calibrate - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
        });
    ...
    setContinuousRecording(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set continuous recording - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setContinuousRecordingType(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set continuous recording type - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    enableDefaultAngle(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station enable default angle - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setDefaultAngleIdleTime(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set default angle idle time - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setDefaultAngle(device) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set default angle - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
        });
        this.p2pSession.sendCommandWithStringPayload({
    ...
    setPrivacyAngle(device) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set privacy angle - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
        });
        this.p2pSession.sendCommandWithStringPayload({
    ...
    setNotificationIntervalTime(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set notification interval time - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setSoundDetectionRoundLook(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set sound detection round look - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    startTalkback(device) {
        ...
        logging_1.rootHTTPLogger.debug(`Station start talkback - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
        });
    ...
    stopTalkback(device) {
        ...
        logging_1.rootHTTPLogger.debug(`Station stop talkback - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
        });
        if ((device.isIndoorCamera() && !device.isIndoorPanAndTiltCameraS350()) ||
    ...
    setScramblePasscode(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set scramble passcode - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setWrongTryProtection(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set wrong try protection - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setWrongTryAttempts(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set wrong try attempts - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setWrongTryLockdownTime(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set wrong try lockdown time - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setSmartSafeParams(device, property, value) {
        ...
        const propertyMetadata = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(propertyMetadata, value);
        logging_1.rootHTTPLogger.debug(`Station set smart safe params - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            property: property,
            value: value,
        ...
        if (device.isSmartSafe()) {
            ...
            switch (property) {
                ...
                case types_1.PropertyName.DeviceRemoteUnlockMasterPIN: {
                    if (!this.pinVerified && value === true) {
                        throw new error_1.PinNotVerifiedError("You need to call verifyPIN with correct PIN first to enable this property", {
                            context: {
                                device: device.getSerial(),
                                station: this.getSerial(),
                                propertyName: propertyData.name,
                    ...
                    let newValue = 2;
                    const remoteUnlock = property === types_1.PropertyName.DeviceRemoteUnlock
                        ? value
                        : device.getPropertyValue(types_1.PropertyName.DeviceRemoteUnlock);
                    const remoteUnlockMasterPIN = property === types_1.PropertyName.DeviceRemoteUnlockMasterPIN
                        ? value
                        : device.getPropertyValue(types_1.PropertyName.DeviceRemoteUnlockMasterPIN);
                ...
                case types_1.PropertyName.DeviceNotificationJammed:
                    const settingsValues = [
                        property === types_1.PropertyName.DeviceNotificationUnlockByKey
                            ? value
                            : device.getPropertyValue(types_1.PropertyName.DeviceNotificationUnlockByKey),
                        property === types_1.PropertyName.DeviceNotificationUnlockByPIN
                            ? value
                            : device.getPropertyValue(types_1.PropertyName.DeviceNotificationUnlockByPIN),
                        property === types_1.PropertyName.DeviceNotificationUnlockByFingerprint
                            ? value
                            : device.getPropertyValue(types_1.PropertyName.DeviceNotificationUnlockByFingerprint),
                        property === types_1.PropertyName.DeviceNotificationUnlockByApp
                            ? value
                            : device.getPropertyValue(types_1.PropertyName.DeviceNotificationUnlockByApp),
                        property === types_1.PropertyName.DeviceNotificationDualUnlock
                            ? value
                            : device.getPropertyValue(types_1.PropertyName.DeviceNotificationDualUnlock),
                        property === types_1.PropertyName.DeviceNotificationDualLock
                            ? value
                            : device.getPropertyValue(types_1.PropertyName.DeviceNotificationDualLock),
                        property === types_1.PropertyName.DeviceNotificationWrongTryProtect
                            ? value
                            : device.getPropertyValue(types_1.PropertyName.DeviceNotificationWrongTryProtect),
                        property === types_1.PropertyName.DeviceNotificationJammed
                            ? value
                            : device.getPropertyValue(types_1.PropertyName.DeviceNotificationJammed),
                    ];
                    let modes = 0;
            ...
            logging_1.rootHTTPLogger.debug(`Station set smart safe params - payload`, {
                stationSN: this.getSerial(),
                deviceSN: device.getSerial(),
                property: property,
                value: value,
    ...
    unlock(device) {
        ...
        logging_1.rootHTTPLogger.debug(`Station unlock - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            payload: payload.toString("hex"),
        });
    ...
    verifyPIN(device, pin) {
        ...
        if (!/^[1-6]{4,8}$/.test(pin)) {
            throw new error_1.InvalidCommandValueError("PIN should contain only numbers (1-6) and be between 4 and 8 long", {
                context: {
                    device: device.getSerial(),
                    station: this.getSerial(),
                    commandName: commandData.name,
        ...
        logging_1.rootHTTPLogger.debug(`Station verify pin - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            payload: payload.toString("hex"),
        });
    ...
    setVideoTypeStoreToNAS(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        if (device.getPropertyValue(types_1.PropertyName.DeviceContinuousRecording) !== true &&
            value === types_1.VideoTypeStoreToNAS.ContinuousRecording) {
            this.setContinuousRecording(device, true);
        }
        logging_1.rootHTTPLogger.debug(`Station set video type store to nas - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    snooze(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station snooze - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    addUser(device, username, shortUserId, passcode, schedule) {
        ...
        if (!/^\d{4,8}$/.test(passcode)) {
            throw new error_1.InvalidCommandValueError("Passcode should contain only numbers and be between 4 and 8 long", {
                context: {
                    device: device.getSerial(),
                    station: this.getSerial(),
                    commandName: commandData.name,
        ...
        logging_1.rootHTTPLogger.debug(`Station add user  - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            username: username,
            shortUserId: shortUserId,
        ...
        if (device.isLockWifi() || device.isLockWifiNoFinger()) {
            ...
            logging_1.rootHTTPLogger.debug("Add user...", {
                station: this.getSerial(),
                device: device.getSerial(),
                admin_user_id: this.rawStation.member.admin_user_id,
                payload: command,
    ...
    deleteUser(device, username, shortUserId) {
        ...
        logging_1.rootHTTPLogger.debug(`Station delete user - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            username: username,
            shortUserId: shortUserId,
    ...
    updateUserSchedule(device, username, shortUserId, schedule) {
        ...
        logging_1.rootHTTPLogger.debug(`Station update user schedule - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            username: username,
            shortUserId: shortUserId,
    ...
    updateUserPasscode(device, username, passwordId, passcode) {
        ...
        logging_1.rootHTTPLogger.debug(`Station update user passcode - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            username: username,
            passwordId: passwordId,
    ...
    setLockV12Params(device, property, value) {
        ...
        const propertyMetadata = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(propertyMetadata, value);
        logging_1.rootHTTPLogger.debug(`Station set lock v12 settings - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            property: property,
            value: value,
        ...
        if (device.isLockWifiR10() || device.isLockWifiR20()) {
            ...
            logging_1.rootHTTPLogger.debug(`Station set lock v12 settings - payload`, {
                stationSN: this.getSerial(),
                deviceSN: device.getSerial(),
                property: property,
                value: value,
    ...
    setSmartLockParams(device, property, value) {
        ...
        const propertyMetadata = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(propertyMetadata, value);
        logging_1.rootHTTPLogger.debug(`Station set smart lock settings - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            property: property,
            value: value,
        ...
        if (device.isLockWifiT8506() ||
            ...
            logging_1.rootHTTPLogger.debug(`Station set smart lock settings - payload`, {
                stationSN: this.getSerial(),
                deviceSN: device.getSerial(),
                property: property,
                value: value,
    ...
    setAutoLock(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set auto lock - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setAutoLockSchedule(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set auto lock schedule - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setAutoLockScheduleStartTime(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set auto lock schedule start time - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setAutoLockScheduleEndTime(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set auto lock schedule end time - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setAutoLockTimer(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set auto lock timer - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setOneTouchLocking(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set one touch locking - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setSound(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set sound - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setNotification(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set notification - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setNotificationLocked(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set notification locked - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setNotificationUnlocked(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set notification unlocked - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    queryAllUserId(device) {
        ...
        logging_1.rootHTTPLogger.debug(`Station query all user id - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
        });
        if (device.isLockBleNoFinger() || device.isLockBle()) {
            throw new error_1.NotSupportedError("This functionality is not implemented by this device", {
                context: { device: device.getSerial(), station: this.getSerial(), commandName: commandData.name },
            });
            ...
            logging_1.rootHTTPLogger.debug("Querying all user id...", {
                station: this.getSerial(),
                device: device.getSerial(),
                admin_user_id: this.rawStation.member.admin_user_id,
                payload: command,
    ...
    downloadImage(cover_path) {
        ...
        logging_1.rootHTTPLogger.debug(`Station download image - sending command`, {
            stationSN: this.getSerial(),
            value: cover_path,
        });
        this.p2pSession.sendCommandWithStringPayload({
    ...
    databaseQueryLocal(serialNumbers, startDate, endDate, eventType = 0, detectionType = 0, storageType = 0) {
        ...
        logging_1.rootHTTPLogger.debug(`Station database query local - sending command`, {
            stationSN: this.getSerial(),
            serialNumbers: serialNumbers,
            startDate: startDate,
            endDate: endDate,
    ...
    databaseQueryByDate(serialNumbers, startDate, endDate, eventType = 0, detectionType = 0, storageType = 0) {
        const commandData = {
            name: types_1.CommandName.StationDatabaseQueryByDate,
            value: {
                serialNumbers: serialNumbers,
                eventType: eventType,
                detectionType: detectionType,
        ...
        logging_1.rootHTTPLogger.debug(`Station database query by date - sending command`, {
            stationSN: this.getSerial(),
            serialNumbers: serialNumbers,
            startDate: startDate,
            endDate: endDate,
        ...
        this.p2pSession.sendCommandWithStringPayload({
            ...
            value: JSON.stringify({
                ...
                mValue3: 0,
                payload: {
                    cmd: types_2.CommandType.CMD_DATABASE_QUERY_BY_DATE,
                    payload: {
                        count: 100,
                        detection_type: detectionType,
                        device_info: devices,
    ...
    databaseCountByDate(startDate, endDate) {
        ...
        logging_1.rootHTTPLogger.debug(`Station database count by date - sending command`, {
            stationSN: this.getSerial(),
            startDate: startDate,
            endDate: endDate,
        });
    ...
    onDatabaseQueryByDate(returnCode, data) {
    ...
    setMotionDetectionTypeHuman(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set motion detection type human - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setMotionDetectionTypeAllOtherMotions(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set motion detection type all other motions - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    _setLightSettingsLightingActiveMode(device, propertyName, value, type) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set set light settings lighting active mode - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            propertyName: propertyName,
            value: value,
            ...
            switch (value) {
                case types_1.LightingActiveMode.DAILY: {
                    ...
                    this.p2pSession.sendCommandWithStringPayload({
                        commandType: types_2.CommandType.CMD_DOORBELL_SET_PAYLOAD,
                        value: JSON.stringify({
                            commandType: type === "manual"
                                ? types_2.CommandType.CMD_WALL_LIGHT_SETTINGS_MANUAL_DAILY_LIGHTING
                                : type === "schedule"
                                    ? types_2.CommandType.CMD_WALL_LIGHT_SETTINGS_SCHEDULE_DAILY_LIGHTING
                                    : types_2.CommandType.CMD_WALL_LIGHT_SETTINGS_MOTION_DAILY_LIGHTING,
                ...
                case types_1.LightingActiveMode.COLORED: {
                    ...
                    if (!colors.some((color) => color.red === currentPropertyValue.red &&
                    ...
                    this.p2pSession.sendCommandWithStringPayload({
                        ...
                        value: JSON.stringify({
                            commandType: type === "manual"
                                ? types_2.CommandType.CMD_WALL_LIGHT_SETTINGS_MANUAL_COLORED_LIGHTING
                                : type === "schedule"
                                    ? types_2.CommandType.CMD_WALL_LIGHT_SETTINGS_SCHEDULE_COLORED_LIGHTING
                    ...
                    this.p2pSession.sendCommandWithStringPayload({
                        ...
                        value: JSON.stringify({
                            commandType: type === "manual"
                                ...
                                : type === "schedule"
                                    ? types_2.CommandType.CMD_WALL_LIGHT_SETTINGS_SCHEDULE_DYNAMIC_LIGHTING
    ...
    setLightSettingsManualDailyLighting(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings manual daily lighting - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setLightSettingsManualColoredLighting(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set light settings manual colored lighting - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setLightSettingsManualDynamicLighting(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings manual dynamic lighting - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setLightSettingsMotionDailyLighting(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings motion daily lighting - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setLightSettingsMotionColoredLighting(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set light settings motion colored lighting - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setLightSettingsMotionDynamicLighting(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings motion dynamic lighting - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setLightSettingsScheduleDailyLighting(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings schedule daily lighting - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setLightSettingsScheduleColoredLighting(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set light settings schedule colored lighting - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setLightSettingsScheduleDynamicLighting(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings schedule dynamic lighting - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setLightSettingsColoredLightingColors(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings colored lighting colors - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
        if (device.isWallLightCam()) {
            ...
            if (value.length > 0 && value.length <= 15) {
                ...
                if (value.length - count + colors.length > 15) {
                    throw new error_1.InvalidPropertyValueError("This property can contain a maximum of 15 items, of which the first 10 are fixed. You can either deliver the first 10 static items with the maximum 5 freely selectable items or only the maximum 5 freely selectable items.", {
                        context: {
                            device: device.getSerial(),
                            station: this.getSerial(),
                            propertyName: propertyData.name,
    ...
    setLightSettingsDynamicLightingThemes(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set light settings dynamic lighting themes - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
        if (device.isWallLightCam()) {
            ...
            if (value.length > 0 && value.length <= 23) {
                ...
                if (value.length - count + themes.length > 23) {
                    throw new error_1.InvalidPropertyValueError("This property can contain a maximum of 23 items, of which the first 3 are fixed. You can either deliver the first 3 static items with the maximum 20 freely selectable items or only the maximum 20 freely selectable items.", {
                        context: {
                            device: device.getSerial(),
                            station: this.getSerial(),
                            propertyName: propertyData.name,
    ...
    setDoorControlWarning(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set door control warning - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    openDoor(device, value, doorId = 1) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station open door - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
            doorId: doorId,
    ...
    calibrateGarageDoor(device, doorId, type) {
        ...
        logging_1.rootHTTPLogger.debug(`Station calibrate garage door  - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            doorId: doorId,
            type: type,
    ...
    setMirrorMode(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set mirror mode - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setFlickerAdjustment(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set flicker adjustment - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setCrossCameraTracking(value) {
        ...
        const property = this.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set cross camera tracking - sending command`, {
            stationSN: this.getSerial(),
            value: value,
        });
        this.p2pSession.sendCommandWithStringPayload({
    ...
    setContinuousTrackingTime(value) {
        ...
        const property = this.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set continuous tracking time - sending command`, {
            stationSN: this.getSerial(),
            value: value,
        });
        this.p2pSession.sendCommandWithStringPayload({
    ...
    setTrackingAssistance(value) {
        ...
        const property = this.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set tracking assistance - sending command`, {
            stationSN: this.getSerial(),
            value: value,
        });
        this.p2pSession.sendCommandWithStringPayload({
    ...
    setCrossTrackingCameraList(value) {
        ...
        const property = this.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set cross tracking camera list - sending command`, {
            stationSN: this.getSerial(),
            value: value,
        });
        this.p2pSession.sendCommandWithStringPayload({
    ...
    setCrossTrackingGroupList(value) {
        ...
        const property = this.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set cross tracking group list - sending command`, {
            stationSN: this.getSerial(),
            value: value,
        });
        this.p2pSession.sendCommandWithStringPayload({
    ...
    setNotificationIndoor(device, type, value) {
        const propertyData = {
            name: type === types_1.IndoorS350NotificationTypes.ALL_OTHER_MOTION
                ? types_1.PropertyName.DeviceNotificationAllOtherMotion
                : type === types_1.IndoorS350NotificationTypes.HUMAN
                    ? types_1.PropertyName.DeviceNotificationPerson
                    : type === types_1.IndoorS350NotificationTypes.PET
                        ? types_1.PropertyName.DeviceNotificationPet
                        : type === types_1.IndoorS350NotificationTypes.CRYING
                            ? types_1.PropertyName.DeviceNotificationCrying
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set notification type indoor - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            type: type,
            value: value,
        ...
        if (device.isIndoorPanAndTiltCameraS350()) {
            try {
                const notification = device.getRawProperty(device.getPropertyMetadata(propertyData.name).key) !== undefined
                    ? device.getRawProperty(device.getPropertyMetadata(propertyData.name).key)
                    : "0";
                ...
                const error = (0, error_1.ensureError)(err);
                logging_1.rootHTTPLogger.error(`setNotificationIndoor Error`, {
                    error: (0, utils_3.getError)(error),
                    stationSN: this.getSerial(),
                    deviceSN: device.getSerial(),
                });
    ...
    setNotificationFloodlightT8425(device, type, value) {
        const propertyData = {
            name: type === types_1.FloodlightT8425NotificationTypes.ALL_OTHER_MOTION
                ? types_1.PropertyName.DeviceNotificationAllOtherMotion
                : type === types_1.FloodlightT8425NotificationTypes.HUMAN
                    ? types_1.PropertyName.DeviceNotificationPerson
                    : type === types_1.FloodlightT8425NotificationTypes.PET
                        ? types_1.PropertyName.DeviceNotificationPet
                        : types_1.PropertyName.DeviceNotificationVehicle,
            value: value,
        };
        if (device.getStationSerial() !== this.getSerial()) {
            throw new error_1.WrongStationError("Device is not managed by this station", {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set notification type floodlight T8425 - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            type: type,
            value: value,
        ...
        if (device.isFloodLightT8425() || device.isCameraC35()) {
            try {
                ...
                const error = (0, error_1.ensureError)(err);
                logging_1.rootHTTPLogger.error(`setNotificationFloodlightT8425 Error`, {
                    error: (0, utils_3.getError)(error),
                    stationSN: this.getSerial(),
                    deviceSN: device.getSerial(),
                });
    ...
    presetPosition(device, position) {
        ...
        logging_1.rootHTTPLogger.debug(`Station preset position - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            preset: types_1.PresetPositionType[position],
        });
        if (device.isFloodLightT8425() ||
            device.isIndoorPanAndTiltCameraS350() ||
            device.isOutdoorPanAndTiltCamera() ||
    ...
    savePresetPosition(device, position) {
        ...
        logging_1.rootHTTPLogger.debug(`Station save preset position - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            preset: types_1.PresetPositionType[position],
        });
    ...
    deletePresetPosition(device, position) {
        ...
        logging_1.rootHTTPLogger.debug(`Station delete preset position - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            preset: types_1.PresetPositionType[position],
        });
    ...
    setLeavingDetection(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set leaving detection - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    _setLeavingReactions(device, propertyData, pushNotification, startTime, endTime) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, propertyData.value);
        logging_1.rootHTTPLogger.debug(`Station set leaving reactions - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            propertyData: propertyData,
            pushNotification: pushNotification,
    ...
    setBeepVolume(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set beep volume - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setNightvisionOptimization(device, value) {
        ...
        logging_1.rootHTTPLogger.debug(`Station set nightvision optimization - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    getLockStatus() {
        ...
        else if (device_1.Device.isLockWifi(this.getDeviceType(), this.getSerial()) ||
            device_1.Device.isLockWifiNoFinger(this.getDeviceType())) {
            this.p2pSession.sendCommandWithStringPayload({
                commandType: types_2.CommandType.CMD_SET_PAYLOAD,
                value: JSON.stringify({
                    account_id: this.rawStation.member.admin_user_id,
                    ...
                    mValue3: 0,
                    payload: {
                        timezone: this.rawStation.time_zone === undefined || this.rawStation.time_zone === ""
                            ? (0, utils_1.getAdvancedLockTimezone)(this.rawStation.station_sn)
    ...
    onSequenceError(channel, command, sequence, serialnumber) {
        ...
        logging_1.rootHTTPLogger.debug(`Station lock sequence error`, {
            stationSN: this.getSerial(),
            channel: channel,
            command: command,
            sequence: sequence,
    ...
    updateUsername(device, username, passwordId) {
        ...
        logging_1.rootHTTPLogger.debug(`Station update username - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            username: username,
            passwordId: passwordId,
        ...
        if (device.isLockWifiR10() || device.isLockWifiR20()) {
            ...
            logging_1.rootHTTPLogger.debug("Station update username - payload", {
                station: this.getSerial(),
                device: device.getSerial(),
                admin_user_id: this.rawStation.member.admin_user_id,
                payload: command,
    ...
    setOpenMethod(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set open method - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    setMotionActivatedPrompt(device, value) {
        ...
        const property = device.getPropertyMetadata(propertyData.name);
        (0, utils_3.validValue)(property, value);
        logging_1.rootHTTPLogger.debug(`Station set motion activated prompt - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
            value: value,
        });
    ...
    open(device) {
        ...
        logging_1.rootHTTPLogger.debug(`Station open - sending command`, {
            stationSN: this.getSerial(),
            deviceSN: device.getSerial(),
        });
        if (device.isSmartDrop()) {
