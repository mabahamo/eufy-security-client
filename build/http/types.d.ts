...
export declare enum EufyCamC35DetectionTypes {
    HUMAN_DETECTION = 3,
    VEHICLE_DETECTION = 4,
    PET_DETECTION = 8,
    ALL_OTHER_MOTION = 32768
...
export declare const DeviceNightvisionCameraC35Property: PropertyMetadataNumeric;
...
export declare const DeviceVideoStreamingQualityCameraC35Property: PropertyMetadataNumeric;
...
export declare const DeviceVideoRecordingQualityCameraC35Property: PropertyMetadataNumeric;
...
export declare const DeviceVideoRecordingQualityCameraC35HB3Property: PropertyMetadataNumeric;
...
export declare const StationStorageInfoSdCardProperty: PropertyMetadataObject;
